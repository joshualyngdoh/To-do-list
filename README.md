...
**[To-do-list]** is a a solo programming project that highlights the use of Webpack.
...
- On the terminal run this command git clone https://github.com/joshualyngdoh/To-Do-List.git
...
https://github.com/joshualyngdoh/To-Do-List.git
...
git clone https://github.com/joshualyngdoh/To-Do-List.git
